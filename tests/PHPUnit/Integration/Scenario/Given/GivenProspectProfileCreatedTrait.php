...
trait GivenProspectProfileCreatedTrait
{
    final protected function givenProspectProfileCreated(
        string $prospectId,
        string $email,
        string $firstName,
        string $lastName,
         ...
         */
        $event = $this->prospectProfileCreatedMessage(
            $prospectId,
            $email,
            $firstName,
            $lastName,
    ...
    private function prospectProfileCreatedMessage(
        string $prospectId,
        string $email,
        string $firstName,
        string $lastName,
