...
trait GivenProspectProfileDeletedTrait
{
    final protected function givenProspectProfileDeleted(string $prospectId): void
    {
        /**
         * @var GenericEvent $event
         */
        $event = $this->prospectProfileDeletedMessage($prospectId);
    ...
    private function prospectProfileDeletedMessage(string $prospectId): DomainMessage
    {
