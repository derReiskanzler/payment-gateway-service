...
trait GivenPlatformUnitContentPublishedTrait
{
    /**
     * @throws BindingResolutionException
     */
    final protected function givenPlatformUnitContentPublished(
        int $unitId,
        string $unitName,
         ...
         */
        $event = $this->platformUnitContentPublishedMessage($unitId, $unitName, $languageCode);
    ...
    private function platformUnitContentPublishedMessage(
        int $unitId,
        string $unitName,
        string $languageCode
    ): DomainMessage {
