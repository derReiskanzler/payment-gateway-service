...
trait GivenProspectProfileUpdatedInKeycloakAdapterTrait
{
    final protected function givenProspectProfileUpdatedInKeycloakAdapter(
        string $prospectId,
        string $email,
        string $firstName,
        string $lastName,
         ...
         */
        $event = $this->prospectProfileUpdatedInKeycloakAdapterMessage(
            $prospectId,
            $email,
            $firstName,
            $lastName,
    ...
    private function prospectProfileUpdatedInKeycloakAdapterMessage(
        string $prospectId,
        string $email,
        string $firstName,
        string $lastName,
