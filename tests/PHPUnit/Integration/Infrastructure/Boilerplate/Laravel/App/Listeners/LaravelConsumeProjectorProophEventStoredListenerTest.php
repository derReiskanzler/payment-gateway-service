...
class LaravelConsumeProjectorProophEventStoredListenerTest extends TestCase
{
    public function testLaravelProduceProjectorProophEventStoredListenerIsCalled(): void
    {
        ...
        Queue::assertPushed(CallQueuedListener::class, static fn ($job) => LaravelConsumeProjectorProophEventStoredListener::class === $job->class);
    }
}
